...
const form = useForm({
  ...
  region_code: props.city.region_code || '',
  latitude: props.city.latitude || '',
  longitude: props.city.longitude || '',
  population: props.city.population || 0,
});
</script>
  ...
  <AppLayout>
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
      <div class="bg-white shadow-sm rounded-lg p-6">
        ...
        <!-- Form Container -->
        <form @submit.prevent="form.put(`/cities/${city.id}`)" class="space-y-6">
